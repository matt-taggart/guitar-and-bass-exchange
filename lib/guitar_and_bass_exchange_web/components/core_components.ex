defmodule GuitarAndBassExchangeWeb.CoreComponents do
  @moduledoc """
  ...
  import GuitarAndBassExchangeWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GuitarAndBassExchangeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GuitarAndBassExchangeWeb.Gettext, "errors", msg, opts)
    end
  end
