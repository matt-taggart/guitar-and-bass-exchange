defmodule GuitarAndBassExchangeWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_guitar_and_bass_exchange_key",
    signing_salt: "SQCD9fGo",
    same_site: "Lax"
  ]
  ...
  plug Plug.Static,
    at: "/",
    from: :guitar_and_bass_exchange,
    gzip: false,
    only: GuitarAndBassExchangeWeb.static_paths()
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :guitar_and_bass_exchange
  end
  ...
  plug GuitarAndBassExchangeWeb.Router
end
